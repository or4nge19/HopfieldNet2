...
/--
Canonical finite Hopfield model.

At the rebuild stage, Hopfield is treated as a **pairwise binary-spin model**.
Its mathematically distinctive features should appear through additional structure
(Hebbian couplings, stored patterns, retrieval observables), not through a second
copy of the base Hamiltonian machinery.
-/
