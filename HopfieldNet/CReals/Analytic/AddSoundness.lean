...
@[simp] theorem add_taylorCoeff_zero (ar₁ : AnalyticReal V₁) (ar₂ : AnalyticReal V₂) :
    AnalyticReal.taylorCoeff (AnalyticReal.add ar₁ ar₂) 0 = 0 := by
  simpa using AnalyticReal.taylorCoeff_zero (AnalyticReal.add ar₁ ar₂)
